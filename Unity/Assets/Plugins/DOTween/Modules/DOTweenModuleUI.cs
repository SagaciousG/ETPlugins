...
namespace DG.Tweening
{
	public static class DOTweenModuleUI
    {
        ...
        {
            if (endValue == null) {
                if (DG.Tweening.Core.Debugger.logPriority > 0) DG.Tweening.Core.Debugger.LogWarning("You can't pass a NULL string to DOText: an empty string will be used instead to avoid errors");
                endValue = "";
            }
